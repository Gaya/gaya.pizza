...
grunt build
```
 ![grunt-build](/articles/grunt-build.gif)[The complete file outcome can be found as a Gist](https://gist.github.com/Gaya/7498780#file-build-gruntfile-js "The complete Gruntfile.js"). Further improvement
-------------------
